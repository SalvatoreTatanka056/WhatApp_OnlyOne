...
namespace WhatsApp_One.ControlsSuite
{
    public partial class ConversationCtrl : UserControl
    {
        ...
        //---------------------------------------------------------------------------------------------------
        [Browsable(true)]
        Color m_PanelDividersBackColor = Color.Navy;
        public Color PanelDividersBackColor
        {
            get 
            { 
                return panelSplit.BackColor; 
            }

            set 
            {
                panelSplit.BackColor = value;
                panelAddresses.BackColor = value;
            }
        }
        //---------------------------------------------------------------------------------------------------
        String m_MeText = "Me";
